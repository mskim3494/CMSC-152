...
stage get_stage(unsigned int selection)
{
    ...
    object s;
    sphere sphere1= sphere_expr(v3_expr(0,0,3),1, &bluish, rgb_expr(1.0,1.0,1.0));
    ...
    poster poster1= poster_expr(v3_expr(-1.0,1.0,4.0),2.0, 1.0, &red, rgb_expr(0,0,0));
    object p;
    p.tag= POSTER;
    p.o.p= poster1;
    ...
    stage test_stage_3;
    camera test_camera_2= new_camera(v3_expr(0,0,-5), 240, 240);
    object ws, rs;
    ...
    s2.tag= SPHERE;
    s2.o.s= sphere2;
    obj_list* sphere2_list= ol_cons(p,ol_singleton(s2));
